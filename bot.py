...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("STATUS_"):
        ...
        if status == "COOKING":
            ...
            await query.edit_message_text(new_text, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Готово", callback_data="STATUS_READY_" + order_id_str)]]), parse_mode="Markdown")
            if order_id_int and order_id_int in order_waiter:
                try:
